...
class Punto(Figura):
    def dibujar(self,lienzo):
        lienzo.create_oval(self.x,self.y,self.x+5,self.y+5,fill=self.color)
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_oval(self.x,self.y,self.x+5,self.y+5,fill="tan2")

    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_oval(corX,corY,corX+5,corY+5,fill=color,outline="white")

    def borrarFigura(self,lienzo):
         lienzo.create_oval(self.x,self.y,self.x+5,self.y+5,fill="white")


class Rectangulo(Figura):
    def dibujar(self,lienzo):
        self.ordenarCordenadas()
        lienzo.create_rectangle(self.x,self.y,self.fX,self.fY,outline=self.color)

    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_rectangle(corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,outline=color)
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_rectangle(self.x,self.y,self.fX,self.fY,outline="tan2")

class Linea(Figura):
    def dibujar(self,lienzo):
        lienzo.create_line(self.x,self.y,self.fX,self.fY,fill=self.color)
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_line(self.x,self.y,self.fX,self.fY,fill="tan2")

    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_line(corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,fill=color)
...
class Circulo(Figura):
    def dibujar(self,lienzo):
        self.ordenarCordenadas()
        lienzo.create_oval(self.x,self.y,self.fX,self.fY,outline=self.color)
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_oval(self.x,self.y,self.fX,self.fY,outline="tan2")

    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_oval(corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,outline=color)
...
class Triangulo(Figura):
    def dibujar(self,lienzo):
        lienzo.create_line(self.x,self.y,self.fX,self.fY,fill=self.color) # HIPOTENUSA
        lienzo.create_line(self.x,self.y,self.fX,self.y,fill=self.color) # BASE
        lienzo.create_line(self.fX,self.y,self.fX,self.fY,fill=self.color) # ALTURA
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_line(self.x,self.y,self.fX,self.fY,fill="tan2") # HIPOTENUSA
        lienzo.create_line(self.x,self.y,self.fX,self.y,fill="tan2") # BASE
        lienzo.create_line(self.fX,self.y,self.fX,self.fY,fill="tan2") # ALTURA

    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_line(corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,fill=color)
        lienzo.create_line(corX,corY,self.fX-self.x+corX,corY,fill=color)
        lienzo.create_line(self.fX-self.x+corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,fill=color)
...
class Texto(Figura):
    ...
    def dibujar(self,lienzo):
        lienzo.create_text(self.x,self.y,text=self.texto,font=("Calibri",self.tLetra),fill=self.color,anchor="nw")
    ...
    def dibujarSeleccion(self,lienzo):
        lienzo.create_text(self.x,self.y,text=self.texto,font=("Calibri",self.tLetra),fill="tan2",anchor="nw")
    ...
    def dibujarMovido(self,lienzo,corX,corY,color):
        lienzo.create_text(corX,corY,text=self.texto,font=("Calibri",self.tLetra),fill=self.color,anchor="nw")

    def dibujarMovidoRectangulo(self,lienzo,corX,corY,color):
        lienzo.create_rectangle(corX,corY,self.fX-self.x+corX,self.fY-self.y+corY,fill=color,outline=color)
